...
export const siteConfig: SiteConfig = {
	title: "xcpolping的小站",
	subtitle: "everything is better than nothing",
	siteURL: "https://mizuki-blog-rust.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "1889661897", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/chenyuhang8563",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1889661897",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/xcpolping",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/akane.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "xcpolping",
